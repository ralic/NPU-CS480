...
public class FRWR {
    ...
    // spliter = [,] as default
    // Assumption : each line may have multple [,]
    // Split : Save 1st line in mutil elements array with indexsize = size.
    // Splitss : Save next line in multi elements array with 2nd dimension = size2.
    public void FRWRnf(int n, String filename2) throws IOException, NullPointerException {
        ...
        int size = 999;
        int size2 = 999;
        int counts = 0; // counts save lines.
